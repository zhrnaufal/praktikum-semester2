        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
            <div class="show-box wow fadeInUp" data-wow-delay="0.3s">
              <img src="<?php echo base_url('assets/img/feature/intro-mobile.png')?>" alt="">
            </div>
          </div>
          <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-12 col-xs-12">
            ...
            <div class="team-item wow fadeInRight" data-wow-delay="0.2s">
              <div class="team-img">
                <img class="img-fluid" src="<?php echo base_url('assets/img/team/team-01.png')?>" alt="">
              </div>
              <div class="contetn">
                <div class="info-text">
          ...
          <div class="col-lg-6 col-md-12 col-xs-12">
            ...
            <div class="team-item wow fadeInRight" data-wow-delay="0.4s">
              <div class="team-img">
                <img class="img-fluid" src="<?php echo base_url('assets/img/team/team-02.png')?>" alt="">
              </div>
              <div class="contetn">
                <div class="info-text">
          ...
          <div class="col-lg-6 col-md-12 col-xs-12">
            ...
            <div class="team-item wow fadeInRight" data-wow-delay="0.6s">
              <div class="team-img">
                <img class="img-fluid" src="<?php echo base_url('assets/img/team/team-03.png')?>" alt="">
              </div>
              <div class="contetn">
                <div class="info-text">
          ...
          <div class="col-lg-6 col-md-12 col-xs-12">
            ...
            <div class="team-item wow fadeInRight" data-wow-delay="0.8s">
              <div class="team-img">
                <img class="img-fluid" src="<?php echo base_url('assets/img/team/team-04.png')?>" alt="">
              </div>
              <div class="contetn">
                <div class="info-text">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div id="testimonials" class="owl-carousel wow fadeInUp" data-wow-delay="1.2s">
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="img-thumb">
                    <img src="<?php echo base_url('assets/img/testimonial/img4.jpg')?>" alt="">
                  </div>
                  <div class="info">
